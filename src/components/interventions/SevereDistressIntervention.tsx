...
import { AlertTriangle, Phone, Send, UserRound, X } from "lucide-react";
...
interface SevereDistressInterventionProps {
  onClose?: () => void;
...
const SevereDistressIntervention: React.FC<SevereDistressInterventionProps> = ({
  onClose = () => {},
  onSendAlert = () => {},
...
export default SevereDistressIntervention;
