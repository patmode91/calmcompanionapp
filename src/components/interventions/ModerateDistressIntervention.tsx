...
interface ModerateDistressInterventionProps {
  onBack?: () => void;
...
const ModerateDistressIntervention: React.FC<
  ModerateDistressInterventionProps
> = ({
  onBack = () => {},
  isPremiumUser = false,
  hotlines = [
...
export default ModerateDistressIntervention;
